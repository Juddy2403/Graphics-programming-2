...
void VulkanBase::drawFrame() {
    ...
    m_GradientShader.UpdateUniformBuffer(imageIndex,m_CommandPool.GetCommandPool(),graphicsQueue);
    //m_Descriptor.UpdateUniformBuffer(imageIndex, UniformBufferObject());
